...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('ajaxreviews', MODX_CORE_PATH . 'components/ajaxreviews/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/ajaxreviews/model/schema/ajaxreviews.mysql.schema.xml';
